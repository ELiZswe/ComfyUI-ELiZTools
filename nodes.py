    ...
    def INPUT_TYPES(s):
        return {
            ...
            "optional": {
                ...
                "normal_deviation_weight": ("FLOAT", {"default": 2.0, "min": 0.0, "max": 32.0,   "tooltip": "Chart Option: Angle between face and average chart normal. Default = 2.0"}),
                "roundness_weight":        ("FLOAT", {"default": 0.01, "min": 0.0, "max": 32.0,  "tooltip": "Chart Option:  Default = 0.01"}),
                "straightness_weight":     ("FLOAT", {"default": 6.0, "min": 0.0, "max": 32.0,   "tooltip": "Chart Option:  Default = 6.0"}),
                "normal_seam_weight":      ("FLOAT", {"default": 4.0, "min": 0.0, "max": 32.0,   "tooltip": "Chart Option: If > 1000, normal seams are fully respected.  Default = 2.4"}),
                "texture_seam_weight":     ("FLOAT", {"default": 0.5, "min": 0.0, "max": 32.0,   "tooltip": "Chart Option: " Default = 0.5}),

                "max_cost":                ("FLOAT", {"default": 2.0, "min": 2.0, "max": 24.0,  "tooltip": "Chart Option: If total of all metrics * weights > maxCost, don't grow chart. Lower values result in more charts.  Default = 2.0"}),
                ...
                "max_chart_size":          ("INT", {"default": 0, "min": 0, "max": 100,         "tooltip": "Pack Option: Charts larger than this will be scaled down. 0 means no limit. Default = 0"}),
                "padding":                 ("INT", {"default": 0, "min": 0, "max": 100,         "tooltip": "Pack Option: Number of pixels to pad charts with". Default = 0}),
